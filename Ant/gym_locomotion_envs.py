...
class WalkerBaseBulletEnv(MJCFBaseBulletEnv):
  ...
  electricity_cost = -0.2  # cost for using motors -- this parameter should be carefully tuned against reward for making progress, other values less improtant
  stall_torque_cost = -0.01  # cost for running electric current through a motor even at zero rotational speed, small
  foot_collision_cost = -0.1  # touches another leg, or other objects, that cost makes robot avoid smashing feet into itself
  foot_ground_object_names = set(["floor"])  # to distinguish ground and other objects
  joints_at_limit_cost = -0.01  # discourage stuck joints
  ...
  def step(self, a):
    ...
    return state, self.rewards, bool(done), {}
